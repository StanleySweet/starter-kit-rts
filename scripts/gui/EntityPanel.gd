...
@onready var health_block : PanelContainer = $MarginContainer/VSplitContainer/PanelContainer
@onready var health_bar : ProgressBar = $MarginContainer/VSplitContainer/PanelContainer/ProgressBar
